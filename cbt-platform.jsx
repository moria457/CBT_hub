...
const DETAILS = {
  ...
  18: { bg: "Psychology Tools — המאגר הגדול בעולם של חומרי CBT מוכנים. דפי עבודה, מדריכים ופרוטוקולים.", steps: ["Worksheets — לכל הפרעה וטכניקה", "Guides — מדריכים קליניים מלאים", "Audio — הקלטות הרפיה", "Translations — חלק בעברית"], tips: "מנוי שנתי (~99$) שווה מאוד למטפל פעיל.", links: [{ l: "Psychology Tools", u: "https://www.psychologytools.com" }] },
  19: {
    bg: "דיכאון הוא הרבה יותר מ'עצב'. זוהי הפרעה רגשית שמשפיעה על המחשבות, הגוף וההתנהגות. אנשים עם דיכאון חווים עצב מתמשך, ירידה בהנאה מדברים שפעם אהבו, קשיי שינה, עייפות, קשיי ריכוז, ולעיתים מחשבות שליליות על עצמם ועל העתיד. חשוב לדעת: דיכאון הוא לא חולשת אופי ולא בחירה — הוא מצב שניתן לטיפול.\n\nלפי הגישה הקוגניטיבית של ג'ודית בק, דיכאון מוזן על ידי מחשבות שליליות אוטומטיות לגבי שלושה תחומים: עצמנו ('אני חסר ערך'), העולם ('שום דבר לא ילך טוב') והעתיד ('אין לי תקווה'). מחשבות אלו מובילות להתנהגויות כמו נסיגה חברתית וצמצום פעילות — שמחמירות את הדיכאון עוד יותר.\n\nCBT מטפל בדיכאון על ידי זיהוי ושינוי מחשבות שליליות אוטומטיות, הגברת פעילויות מהנות ומשמעותיות (הפעלה התנהגותית), ועבודה על אמונות ליבה עמוקות. מחקרים רבים מראים ש-CBT יעיל כמו תרופות לדיכאון קל-בינוני, ולעיתים אפילו עדיף — שכן ההישגים נשמרים לאורך זמן.",
  ...
  20: {
    bg: "חרדה היא תגובה טבעית ואנושית לסכנה. מערכת העצבים שלנו בנויה לזהות איומים ולהפעיל תגובת 'הילחם או ברח' (Fight or Flight) — שבאה לידי ביטוי בדופק מהיר, נשימה מואצת, מתח שרירים ועוירות. בעבר הרחוק, תגובה זו הצילה חיים. הבעיה מתחילה כשהמערכת 'נורה' גם בפני סכנות שאינן מהוות איום ממשי — כמו הצגה בעבודה, מפגש חברתי, או מחשבה מדאיגה.\n\nהגורם המרכזי שמשמר חרדה הוא הימנעות. כשאנחנו נמנעים ממצב מפחיד, אנחנו מרגישים הקלה מיידית — אך בטווח הארוך, הימנעות מחזקת את המוח בכך שהמצב אכן מסוכן. כך נוצר מעגל: פחד → הימנעות → הקלה קצרת טווח → פחד גדול יותר בפעם הבאה.\n\nב-CBT, הטיפול בחרדה כולל הבנת המנגנון, אתגור מחשבות מפחיתות, וחשיפה הדרגתית — כלומר, כניסה מכוונת למצבים מפחידים בצעדים קטנים ובטוחים, עד שהמוח לומד שאין סכנה אמיתית.",
  ...
  21: {
    bg: "הפרעת חרדה מוכללת (GAD — Generalized Anxiety Disorder) מאופיינת בדאגה כרונית, מוגזמת וקשה לשליטה על נושאים שונים בחיים: בריאות, עבודה, כסף, משפחה ועוד. אנשים עם GAD מתקשים לעצור את שרשרת הדאגות, ומרגישים לרוב מתח שרירי, עייפות, קשיי שינה וקשיי ריכוז. לעיתים הם מתארים את עצמם כ'דואגים מטבעם'.\n\nמחקרים מראים שדאגה ב-GAD לא עוזרת לפתור בעיות — היא יוצרת אשליה של שליטה ('אם אדאג, אהיה מוכן') תוך גרימת סבל רציני. לפי CBT, הדאגה מוזנת על ידי אמונות שגויות כמו 'דאגה מגינה עלי' או 'אם משהו רע יקרה, לא אוכל להתמודד'. מחשבות אלו ניתנות לאתגור ולשינוי.\n\nהטיפול ב-GAD כולל: זיהוי נושאי הדאגה, אבחנה בין דאגות ניתנות לפתרון לבין כאלה שאינן, תרגול נכחות (מיינדפולנס) לעצירת שרשרת הדאגות, ואתגור אמונות הליבה על הסכנה וחוסר היכולת להתמודד.",
  ...
  22: {
    bg: "PTSD (הפרעת דחק פוסט-טראומטית) מתפתחת לאחר חשיפה לאירוע טראומטי — תאונה, תקיפה, מלחמה, אסון טבע, אובדן פתאומי ועוד. התגובה לטראומה היא נורמלית לחלוטין — המוח מנסה להתמודד עם חוויה מכריעה. PTSD מאובחן כשהתסמינים נמשכים מעל חודש ופוגעים בתפקוד.\n\nארבע קבוצות תסמינים מרכזיות: (1) חוויה מחודשת — פלאשבקים, סיוטים, מחשבות חודרניות. (2) הימנעות — מהימנעות ממקומות, אנשים, מחשבות שמזכירות את הטראומה. (3) שינויים קוגניטיביים ורגשיים — אשמה, בושה, ניתוק רגשי, תחושת עתיד קצר. (4) עוררות יתר — בהלות קלות, קשיי שינה, קשיי ריכוז, רגזנות.\n\nחשוב להסביר למטופל: הסימפטומים אינם סימן לחולשה או 'שגעון' — הם ביטוי לכך שהמוח לא הספיק לעבד את החוויה. הטיפול (PE, EMDR, CPT) עוזר למוח לסיים את תהליך העיבוד ולאחסן את הזיכרון כ'עבר' במקום כ'הווה מאיים'.",
  ...
  23: {
    bg: "OCD (הפרעה טורדנית-כפייתית) מורכב משני חלקים: אובססיות — מחשבות, דחפים או תמונות חודרניות ומטרידות שחוזרות שוב ושוב. וקומפולסיות — טקסים גופניים או מנטליים שנועדו להפחית את החרדה שהאובססיה יוצרת. הסעד הוא זמני בלבד, ובפעם הבאה המחשבה חוזרת — חזקה יותר.\n\nמחשבות חודרניות הן תופעה אנושית אוניברסלית. כולם חווים לעיתים מחשבות מוזרות, מפחידות או לא רצויות. ההבדל אצל אנשים עם OCD הוא בפרשנות: הם מאמינים שהמחשבה מסוכנת, שמשמעותה משהו על אופיים, ושחייבים לנטרל אותה. דווקא ניסיון הנטרול — הטקסים — הוא שהופך את המחשבה לבעיה.\n\nהטיפול ב-OCD הוא ERP — חשיפה ומניעת תגובה. הרעיון: להיחשף למחשבה המפחידה מבלי לבצע את הטקס, עד שהמוח לומד שהמחשבה אינה מסוכנת וחרדה פוחתת מעצמה. זהו טיפול קשה אך יעיל ביותר — שיעורי ההצלחה גבוהים.",
    ...
    tips: "מטפורת הגל: 'חרדה היא כמו גל בים — אם תניח לו, הוא תמיד יגיע לשיא ואז ייסוג.'",
    ...
    <div onClick={e => e.target === e.currentTarget && onClose()} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)", zIndex: 100, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "16px", overflowY: "auto" }}>
      <div style={{ background: "#fff", borderRadius: 20, width: "100%", maxWidth: 680, boxShadow: "0 20px 60px rgba(0,0,0,0.2)", marginTop: 10 }}>
        ...
        <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {d ? (<>
            <div><div style={{ fontWeight: 700, fontSize: 14, color: "#1E293B", marginBottom: 8 }}>📖 רקע</div><div style={{ fontSize: 13, color: "#374151", lineHeight: 1.85, whiteSpace: "pre-line" }}>{d.bg}</div></div>
            <div>
